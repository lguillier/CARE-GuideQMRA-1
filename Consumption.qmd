...
FAO and WHO have developed the GIFT platform to make food consumption data available by gender and age for many countries, including low-income countries. These data are used to assess dietary exposure to food safety hazards and to identify the main food sources of these hazards for risk analysis. This database is global and publicly accessible. It combines existing data collected through individual food consumption surveys conducted at the national or sub-national level.
...
+-----------------------+----------------------------------------------------------------------+-----------------------+
| Country               | Description                                                          | Access                |
+=======================+======================================================================+=======================+
| France                | Third French Individual and National Food Consumption Survey (INCA3) | data.gouv.fr;         |
|                       |                                                                      |                       |
|                       |                                                                      | inca3 R package       |
+-----------------------+----------------------------------------------------------------------+-----------------------+
|                       |                                                                      |                       |
